...
import com.github.k6mt.surfer.config.ConfigProperties;
import com.github.k6mt.surfer.util.StaticRestTemplate;
...
public class AnthropicClient implements AIClient {
  ...
  public AnthropicClient(ConfigProperties configProperties) {

package com.github.k6mt.surfer.model;

import static com.github.k6mt.surfer.util.Preconditions.checkNotNull;

import com.github.k6mt.surfer.common.ConfigurationException;
import java.io.File;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

/**
 * Home class which enables the easy resource access in ${SURFER_HOME} directory.
 */
public class Home {
